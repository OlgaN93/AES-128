...
const std::array<uint8_t, COLUMN> INV_MATRIX = {0x0e, 0x0b, 0x0d, 0x09};
...
std::array <std::array<uint8_t, COLUMN>, STRING> inv_AES(std::array <std::array<uint8_t, COLUMN>, STRING> data, std::array <std::array<uint8_t, COLUMN>, STRING> key);
...
std::array <std::array<std::array<uint8_t, COLUMN>, STRING>, (CNT_ROUND + 1)> key_generation(std::array <std::array<uint8_t, COLUMN>, STRING>& key);
...
uint8_t inv_multiply(uint8_t state_num, uint8_t matrix_num);
